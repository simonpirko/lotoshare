...
<div class="uk-offcanvas-content">
    ...
    <div class="uk-container uk-margin-medium uk-container-small max-width-for-post-and-new">
        <h1 class="uk-heading-divider uk-text-center">Создание объявления</h1>
        <form class="uk-grid-small" action="/new/save" enctype="multipart/form-data" method="post">
            <fieldset class="uk-fieldset">
                <div class="uk-margin uk-width-1-1@s">
                    <input class="uk-input" type="text" placeholder="Название" minlength="5" maxlength="30" name="title"
                           required>
                </div>

                <div class="uk-column-1-3@s">
                    <div class="uk-margin">
                        <input minlength="3" maxlength="16" class="uk-input" type="text" placeholder="Ваше имя"
                               name="author" required>
                    </div>
                    <div class="uk-margin">
                        <input class="uk-input" type="text" placeholder="Город" minlength="3" maxlength="9" name="city"
                               required>
                    </div>
                    <div class="uk-margin">
                        <input class="uk-input" type="text" placeholder="+375(__)___-__-__" minlength="13" maxlength="13" name="telephone"
                               required>
                    </div>
                </div>
                ...
                <div class="uk-column-1-3@s">
                    ...
                    <div class="uk-margin">
                        <select name="status" class="uk-select">
                            <option value="" selected disabled>Состояние</option>
                    ...
                    <div class="uk-margin">
                        <select name="type" class="uk-select">
                            <option value="" selected disabled>Объявление</option>
                ...
                <div class="uk-column-1-1">
                    <div class="uk-margin">
                        <input minlength="3" maxlength="20" type="text" name="email"
                               class="uk-input"
                ...
                <div class="uk-column-1-1">
                    <div class="uk-margin">
                        <textarea class="uk-textarea" minlength="31" maxlength="255" name="text" rows="5"
                                  placeholder="Текст объявления..." required></textarea>
                    </div>
                </div>
                <div class="uk-column-1-1">
                    <div class="uk-margin">
                ...
                <button type="submit" class="uk-button uk-button-default btn-top">Опубликовать
                </button>
            </fieldset>
        </form>
    </div>
